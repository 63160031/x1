...
class Login extends CI_Controller
{
    ...
    {   
        // print_r(array('requestData'=>array('log_login' => $this->session->userdata('log_login'))));exit;
        // $result = $this->curPostRequest('Api_Controller/logout', array('data' => serialize(array('requestData'=>array('log_login' => $this->session->userdata('log_login')))))); 

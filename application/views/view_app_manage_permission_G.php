      ...
      <div class="card-body">
        <div class="row py-2">
          ...
          <div class="row">
            ...
            <div class="col-4">
              <button type="button" class="btn btn-circle btn-primary" style="letter-spacing: 2px;" id="btnSaveAdd"><span class="tf-icons bx bx-add-to-queue me-1"></span>Register App Permission Group</button>
            </div>
          </div>
        </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Edit App Permission Group</h5>
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col mb-3">
            ...
            <input type="text" id="inpnameGroup" class="form-control" value="">
          </div>
        </div>
      </div>

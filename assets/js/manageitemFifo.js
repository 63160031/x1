            ...
            success: function (data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    html += `
                            ...
                            <td>
                            <i class="bx ${data[i].itf_item} bx-md me-3" ></i>
                            <p class="icon-name text-capitalize text-truncate mb-0"></p>
                            </td>
                            <td><i></i>${data[i].itf_part_no}</td>
                    ...
                    </div><a href="" class="tblEditBtn btn btn-sm btn-icon item-edit" data-bs-toggle="modal" data-bs-target="#mdlEdit" id="btnEdit" data-id="${data[i].itf_id}">

            ...
            if (MenuName == '') {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        formData.append('MenuBtn', MenuBtn);
    ...
    $(document).on('click', '.tblEditBtn', function () {
        ...
        $.ajax({
            ...
            success: (response) => {
                ...
                $('#edtMenuPart').val(response.data.sma_path)
                // }
            }
        });
    })
    ...
    $(document).ready(function () {
        $('#btnSaveEdit').on('click', function () {
            ...
            if (
                ...
                data_acc.sma_button_id == MenuBtn
            ) {
                Swal.fire({
                    icon: 'success',
                    title: 'Not changed !',
                ...
                Swal.fire({
                    icon: 'warning',
                    title: 'Oops...',
                    text: 'Please choose MenuBtn',
                })

            }else if ((MenuName && !isThaiLanguage(MenuName)) || (MenuBtn && !isThaiLanguage(MenuBtn))) {
                Swal.fire({
                    icon: 'warning',
                    title: 'Oops...',

                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        <tr>
                          ...
                          <span class="emp_name text-truncate">${data[i].sa_firstname} ${data[i].sa_lastname}</span><small class="emp_post text-truncate text-muted">${data[i].sa_emp_code}</small></div></div></td>
                            <td><i></i> <strong>${data[i].spg_name}</strong></td>
                            <td><i></i>${data[i].sa_email}</td>
                            <td class="" style="">05/01/2024</td>
